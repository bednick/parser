...
import main.java.ru.old.computationalModel.tree.CMTree;
import main.java.ru.old.computationalModel.tree.CMTreeVertex;
import main.java.ru.old.parser.performing.Perform;
import main.java.ru.old.parser.performing.PerformUnix;
import main.java.ru.old.parser.performing.PerformWin;
import main.java.ru.old.parser.view.View;
import main.java.ru.old.parser.view.ViewConsole;
...
public class Parser {
    ...
    private boolean start() throws IOException {
        /*
        * Основная логика main.java.ru.old.parser'а
        * */
        try {
