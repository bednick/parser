package main.java.ru.old.parser.view;

import main.java.ru.old.parser.Parser;
...
public class ViewConsole extends View {
    ...
    public void printHelp() {
        println("Для работы main.java.ru.old.parser'а доступны следующие входные параметры:");
